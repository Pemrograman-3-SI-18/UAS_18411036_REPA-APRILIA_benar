            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  ...
                  <div class="text-bold items-center">{{dataUser.namaLengkap}}</div>
                </div>
              </div>
        ...
        <q-list>
          ...
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              ...
              <div>UNIVERSITAS APRIL INDONSIA</div>
          ...
          <q-item clickable active-class="active" exact v-ripple to="/datadiripeserta">
